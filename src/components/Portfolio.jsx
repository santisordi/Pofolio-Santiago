...
import reactPorfolio from "../assets/portfolio/PoryectoReactJS-Porfolio.png";
import webLucrecia from "../assets/portfolio/ProyectoWeb-La Lucrecia.png";
import reactRegionales from "../assets/portfolio/ProyectoReactJS-Regionales.png";
import jsCotizador from "../assets/portfolio/ProyectoJS-CotizadorSeguros.png";
...
const Portfolio = () => {
  ...
  return (
    <div name="Porfolio" className='bg-gradient-to-b fromblack to bg-gray-800 w-full text-white md:h-screen'>
